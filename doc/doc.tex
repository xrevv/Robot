...
\begin{center}
    \includegraphics[width=0.9\textwidth]{img/app_src/bluetooth/BluetoothListBefore.png}
    \includegraphics[width=0.9\textwidth]{img/app_src/bluetooth/BluetoothListAfter.png}
    \includegraphics[width=0.9\textwidth]{img/app_src/bluetooth/BluetoothDisconnected.png}
    \includegraphics[width=0.9\textwidth]{img/app_src/bluetooth/BluetoothClient.png}
\end{center}
